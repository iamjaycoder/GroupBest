      ...
      <Wrapper>
        ...
        <ContentHead>
          ...
          <Content1>
            ...
            <Para1>
              Lists and cards are the building blocks of organizing work on a Trello board. Grow
              from there with task assignments, timelines, productivity metrics, calendars, and
              more.
            </Para1>
            <Sub>
              <Sign>+</Sign>
        ...
        <ContentHead1>
          ...
          <Content2>
            ...
            <Para1>
              Trello cards are your portal to more organized work—where every single part of your
              task can be managed, tracked, and shared with teammates. Open any card to uncover an
        ...
        <ContentHead>
          ...
          <Content3>
            ...
            <Para1>
              ...
              built-in automation, Butler, reduce the number of tedious tasks (and clicks) on your
              project board by harnessing the power of automation across your entire team.
            </Para1>
            <Sub>
              <Sign>+</Sign>
              <SubContent>Learn more</SubContent>
        ...
        <ContentHead1>
          ...
          <Content4>
            ...
            <Para1>
              Easily connect the apps your team already uses into your Trello workflow, or add a
              Power-Up that helps fine-tune one specific need. With hundreds of Power-Ups available,
